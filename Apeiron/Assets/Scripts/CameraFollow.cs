...
public class CameraFollow : MonoBehaviour 
{
	...
	public float xSmooth = 0f;		// How smoothly the camera catches up with it's target movement in the x axis.
	public float ySmooth = 0f;      // How smoothly the camera catches up with it's target movement in the y axis.
    [SerializeField]
	...
	void Update(){
			//maxXAndY =new Vector2(130.8f,77.4f);
			//minXAndY =new Vector2(46.6f,47.3f);
